...
$query = "
	SELECT * FROM ims_issue_book 
	INNER JOIN ims_book 
	ON ims_book.book_isbn_number = ims_issue_book.book_id 
	WHERE ims_issue_book.user_id = '".$_SESSION['user_id']."' 
	ORDER BY ims_issue_book.issue_book_id DESC
";
