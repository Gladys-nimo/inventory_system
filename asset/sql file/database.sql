...
INSERT INTO `ims_admin` (`admin_id`, `admin_email`, `admin_password`) VALUES
(1, 'johnsmith1@gmail.com', 'password');

-- --------------------------------------------------------

--
-- Table structure for table `ims_author`
--

CREATE TABLE `ims_author` (
...
--
-- Dumping data for table `ims_author`
--

INSERT INTO `ims_author` (`author_id`, `author_name`, `author_status`, `author_created_on`, `author_updated_on`) VALUES
...
--
-- Table structure for table `ims_book`
--

CREATE TABLE `ims_book` (
...
--
-- Dumping data for table `ims_book`
--

INSERT INTO `ims_book` (`book_id`, `book_category`, `book_author`, `book_location_rack`, `book_name`, `book_isbn_number`, `book_no_of_copy`, `book_status`, `book_added_on`, `book_updated_on`) VALUES
...
INSERT INTO `ims_category` (`category_id`, `category_name`, `category_status`, `category_created_on`, `category_updated_on`) VALUES
...
--
-- Table structure for table `ims_issue_book`
--

CREATE TABLE `ims_issue_book` (
...
--
-- Dumping data for table `ims_issue_book`
--

INSERT INTO `ims_issue_book` (`issue_book_id`, `book_id`, `user_id`, `issue_date_time`, `expected_return_date`, `return_date_time`, `book_fines`, `book_issue_status`) VALUES
...
--
-- Table structure for table `ims_location_rack`
--

CREATE TABLE `ims_location_rack` (
...
--
-- Dumping data for table `ims_location_rack`
--

INSERT INTO `ims_location_rack` (`location_rack_id`, `location_rack_name`, `location_rack_status`, `location_rack_created_on`, `location_rack_updated_on`) VALUES
...
--
-- Table structure for table `ims_setting`
--
...
--
-- Dumping data for table `ims_setting`
--

INSERT INTO `ims_setting` (`setting_id`, `library_name`, `library_address`, `library_contact_number`, `library_email_address`, `library_total_book_issue_day`, `library_one_day_fine`, `library_issue_total_book_per_user`, `library_currency`, `library_timezone`) VALUES
...
INSERT INTO `ims_user` (`user_id`, `user_name`, `user_address`, `user_contact_no`, `user_profile`, `user_email_address`, `user_password`, `user_verificaton_code`, `user_verification_status`, `user_unique_id`, `user_status`, `user_created_on`, `user_updated_on`) VALUES
...
--
-- Indexes for table `ims_admin`
--
ALTER TABLE `ims_admin`
  ADD PRIMARY KEY (`admin_id`);

--
-- Indexes for table `ims_author`
--
ALTER TABLE `ims_author`
  ADD PRIMARY KEY (`author_id`);

--
-- Indexes for table `ims_book`
--
ALTER TABLE `ims_book`
...
--
-- Indexes for table `ims_issue_book`
--
ALTER TABLE `ims_issue_book`
  ADD PRIMARY KEY (`issue_book_id`);

--
-- Indexes for table `ims_location_rack`
--
ALTER TABLE `ims_location_rack`
  ADD PRIMARY KEY (`location_rack_id`);

--
-- Indexes for table `ims_setting`
--
...
--
-- AUTO_INCREMENT for table `ims_admin`
--
ALTER TABLE `ims_admin`
  MODIFY `admin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `ims_author`
--
ALTER TABLE `ims_author`
  MODIFY `author_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `ims_book`
--
ALTER TABLE `ims_book`
